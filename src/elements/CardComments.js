      ...
      <View style={{flexDirection: 'row'}}>
        ...
        <View style={styles.right}>
          <Text style={{ fontSize: 16, color: '#ffffff', marginTop: 7 }}>
            Due to the quality and recently scandal, I think we should take a serious concern about this.
          </Text>
          <Text style={{ fontSize: 13, color: '#dbdbdb', bottom: -65, right: -40 }}>
            votes
          </Text>
        </View> 
        <View style={{flexDirection: 'column', marginVertical: 10, justifyContent: 'space-between'}}>
