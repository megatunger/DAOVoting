...
import {Alert, ImageBackground, Dimensions ,StyleSheet, Text, View, Image, TouchableWithoutFeedback, StatusBar, TextInput, SafeAreaView, Keyboard, TouchableOpacity, KeyboardAvoidingView }  from 'react-native';
...
render() {
    ...
    <View style={styles.container}>
            <Image style={{width: 458/1.8, height: 136/1.8, marginBottom: 30}}
